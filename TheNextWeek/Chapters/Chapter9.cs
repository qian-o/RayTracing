...
public class Chapter9 : IChapter
{
    public void Run()
    {
        ...
        DiffuseLight light = new(new SolidColor(new Vector3D<double>(7.0, 7.0, 7.0)));
        ...
        world.Add(new Quad(new Vector3D<double>(113.0, 554.0, 127.0), new Vector3D<double>(330.0, 0.0, 0.0), new Vector3D<double>(0.0, 0.0, 305.0), light));
        world.Add(new Quad(new Vector3D<double>(0.0, 555.0, 0.0), new Vector3D<double>(555.0, 0.0, 0.0), new Vector3D<double>(0.0, 0.0, 555.0), white));
        ...
        world.Add(new ConstantMedium(box1, 0.01, new Vector3D<double>(0.0, 0.0, 0.0)));
        world.Add(new ConstantMedium(box2, 0.01, new Vector3D<double>(1.0, 1.0, 1.0)));
